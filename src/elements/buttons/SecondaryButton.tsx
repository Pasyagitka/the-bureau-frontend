...
function SecondaryButton({
  ...
  return isLink ? (
    <NavLink
      to={to}
      className="bg-gray-300 hover:bg-gray-300 align-middle focus-visible:ring ring-lime-300 text-gray-800 active:text-gray-900 text-sm text-center rounded-lg outline-none transition duration-100 px-8 py-3 md:text-base inline-block px-[16px] py-[8px] font-normal"
    >
      {title}
    </NavLink>
  ) : (
