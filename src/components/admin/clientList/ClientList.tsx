  ...
  return (
    <div className="w-full bg-white p-12 container rounded">
      <div className="header flex items-end justify-between mb-12">
        <div className="title">
          <p className="text-4xl font-bold text-gray-700 mb-4">Клиенты</p>
          <p className="text-2xl font-light text-gray-400">Общее количество клиентов: {clients.length}.</p>
        </div>
