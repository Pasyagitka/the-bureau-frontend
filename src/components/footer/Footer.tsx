function Footer() {
  return (
    <footer className="w-full px-3 py-8 mt-8 relative bg-white text-2 text-gray-500 transition-colors duration-200 left-0 bottom-0">
      <div className="flex flex-col">
        ...
        <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
          <nav className="flex-1 flex flex-col items-center justify-center md:items-end md:border-r border-gray-100 md:pr-5">
            <a aria-current="page" href="#" className="hover:text-gray-700 ">
              Components
            </a>
            <a aria-current="page" href="#" className="hover:text-gray-700">
              Contacts
