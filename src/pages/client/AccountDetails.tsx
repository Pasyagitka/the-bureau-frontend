...
function AccountDetails({ surname, firstname, patronymic, phone }) {
  return (
    <section className="h-screen bg-gray-100 bg-opacity-50 w-full">
      <form className="container max-w-2xl mx-auto shadow-md md:w-3/4">
        <div className="p-4 bg-gray-100 border-t-2 border-lime-400 rounded-lg bg-opacity-5">
          <div className="max-w-sm mx-auto md:w-full md:mx-0">
            <div className="inline-flex items-center space-x-4">
              <a href="#" className="block relative">
                <img alt="profil" src={icon} className="mx-auto object-cover rounded-full h-16 w-16 " />
              </a>
              <h1 className="text-gray-600">Change your account information</h1>
            </div>
          </div>
        </div>
